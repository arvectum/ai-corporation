...
from src.modules.production_llm_analysis.openai_compatible import (
    OpenAICompatibleProductionLLMProvider, OpenAICompatibleTransportConfig
)
...
from src.modules.production_llm_analysis.llama_schema_constraint import (
    install_llama_schema_constraint, enable_live_boundary_verification
)
...
def create_mock_request():
    fragments = [
        EvidenceFragmentInput(
            ...
            locator={"page": 1}, text="This is a test claim value."
        )
    ]
